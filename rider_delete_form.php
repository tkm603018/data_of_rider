...
削除したい選手を選択して送信ボタンを押してください。<BR><BR>

<FORM ACTION="rider_delete.php" METHOD="GET">
...
// SQLを作成
$sql = "select rider_id, team_name, rider_name, age, nationality, height, weight from rider, team where rider.team_id = team.team_id order by rider_id";
